...
V73 增加《小海龟回家》《大家的面包》《雨天森林邮局》三本低龄听读绘本。
每本由 6 页短句故事、3 道图片选择题和 3 个跟读词组组成。主操作使用大图、
喇叭和翻页箭头；点击「开始讲故事」后，页面依次播放中文讲述和英语短句，翻页后
继续带读但不会自动翻走。题干、选项、提示和答题反馈均可朗读，孩子不需要依靠文字
完成。家长文字与带读设置保留在次级入口。

V74 增加火车主题绘本《苹果坐上小火车》，用连续分镜讲苹果装进保鲜箱、吊装
上车、跟随绿色信号出发、穿过山谷并抵达商店的过程。课程保持 6 页短句故事、
3 道图片选择题和 3 个跟读词组，并复用相同的无字化听读交互。
